package br.com.maddytec.ibgeservice.config;
...
public class KafkaConfig {
    ...
    private String requestReplyTopicEstado;
    ...
    public KafkaMessageListenerContainer<String, String> replyContainer(ConsumerFactory<String, String> cf) {
        ContainerProperties containerProperties = new ContainerProperties(requestReplyTopicEstado, requestReplyTopicCidade);
